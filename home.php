            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                        <h3 class="text-white">Bienvenido  Primos al <?php echo $_SESSION['setting_name']; ?></h3>
                                ...
                                <form id="manage-filter" action="index.php?page=flights" method="POST">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3" id="rdate" style="display: none">
                                            <label for="" class="control-label">Fecha Retorno</label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3 offset-sm-5">
                                            <button class="btn btn-block btn-sm btn-primary" type="submit"><i class="fa fa-plane-departure"></i> Buscar Vuelos</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
