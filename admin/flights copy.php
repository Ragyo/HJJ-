		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Agregar Reservaciones</b>
				</large>
				<button class="btn btn-primary btn-block col-md-2 float-right" type="button" id="new_flight"><i class="fa fa-plus"></i> Nueva Reservacion</button>
			</div>
			<div class="card-body">
